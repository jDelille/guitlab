...
const SOUNDS: { label: string; value: MetronomeSound; freq: number; type: OscillatorType; decay: number }[] = [
  { label: "Click", value: "click", freq: 1000, type: "sine",     decay: 0.04 },
  { label: "Wood",  value: "wood",  freq: 250,  type: "triangle", decay: 0.08 },
  { label: "Soft",  value: "soft",  freq: 600,  type: "sine",     decay: 0.10 },
];
...
const PlayScale = ({ settings, setSettings }: PlayScaleProps) => {
  ...
  useEffect(() => {
    ...
    tick();
    metronomeIntervalRef.current = window.setInterval(tick, (60 / settings.playScaleBpm) * 1000);
      ...
      <div className="play-scale__settings-wrapper" ref={menuRef}>
        ...
        {menuOpen && (
          <div className="play-scale__menu">
            ...
            <span className="play-scale__menu-label" style={{ marginTop: "8px" }}>Metronome Sound</span>
            <ul>
            ...
            <span className="play-scale__menu-label" style={{ marginTop: "8px" }}>Metronome Volume</span>
